...
export default function EditorViewport({ editor }: { editor: TerrainEditor }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-4 top-5 flex items-center md:right-6">
      ...
      {!preview && !editor.navigate && <PaintingTools editor={editor} />}
      <div className="absolute bottom-5 left-5 right-5 flex items-center justify-between">
        ...
        <button
          ...
          onClick={() => setHelp((v) => !v)}
          className="size-5 rounded-full border border-muted/40 text-[10px] text-muted"
        >
          ?
        </button>
      </div>
